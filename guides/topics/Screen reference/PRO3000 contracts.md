...
| **Status** label                    |                          |
| **Customer name** title             |                          |
| **Contract and tariff** description |                          |
| **Total amount** description        |                          |
| **Contract date** description       | (German: Abschlussdatum) |
#### Listing filters
| Element                   | Description               |
| ------------------------- | ------------------------- |
| **Product** field         |                           |
| **Status** field          |                           |
| **Total amount** field    |                           |
| **Contract date** field   | (German: Abschlussdatum)  |
| **Acceptance date** field | (German: Annahmedatum)    |
| **Start date** field      | (German: Vertragsbeginn)  |
...
| **Start and end date** field        | (German: Vertragsbeginn, Vertragsende)                                                         |
| **Result start and end date** field | (German: Ergebnisbeginn, Ergebnisende)                                                         |
| **Reversal date** field             | (German: Stornodatum)                                                                          |
| **Contract type** field             | (German: Beteiligungsart)                                                                      |
#### Details area
| Tab                    | Description                      |
| ---------------------- | -------------------------------- |
| **Record** tab         | (German: Akte)                   |
| **Person data** tab    | (German: Personendaten)          |
| **Balances** tab       | (German: Salden)                 |
...
| **Purpose** column               | (German: Verwendung)  |
| **Reason for suspension** column | (German: Sperrgrund)  |
| **Bank** column                  |                       |
| **Type** column                  |                       |
| **Dedicated account** column     | (German: Zweckkonto)  |
...
| **Posting date** field       | Effective date for when funds are considered available (German: Valutadatum). |
| **Account** field            | (German: Konto)                                                               |
| **Counter account** field    | (German: Gegenkonto)                                                          |
| **Tax code** field           | (German: Steuerkennzeichen)                                                   |
| **Amount** field             | (German: Betrag)                                                              |
| **Currency** field           | (German: Währung)                                                             |
| **Booking text** field       | (German: Buchungstext)                                                        |
| **Voucher number** field     | (German: Beleg-Nr.)                                                           |
| **Transaction number** field | (German: Transaktions-Nr.)                                                    |
