...
export const UiLayoutPage = () => {
  useDocumentTitle("ui: layout");
        ...
        <div className="grid grid-cols-[auto_1fr_auto] h-full">
          <Theme theme="light">
            <div className="flex flex-col w-[240px] bg-(--bg-base) border-r border-(--border-base)">
              <div className="p-[14px] pr-[8px] flex items-center text-sm gap-2">
                ...
                <UiIcon name="selector" variant="outlined" height={18} strokeWidth={2} />
                <div className="ml-auto flex items-center justify-center size-[30px]">
                  <UiIcon name="layout-sidebar" variant="outlined" height={18} strokeWidth={2} />
                </div>
              </div>
          ...
          <div className="flex flex-col bg-(--bg-layer)">
            <div className="px-[14px] flex items-center h-[44px]">
              ...
              <div className="flex items-center justify-center size-[30px]">
                <UiIcon name="arrow-left" variant="outlined" height={18} strokeWidth={2} />
              </div>
              <div className="flex items-center justify-center size-[30px]">
                <UiIcon name="arrow-right" variant="outlined" height={18} strokeWidth={2} />
              </div>
              <div className="text-(--fg-base)">text base</div>
              <div className="ml-auto flex items-center justify-center size-[30px] text-(--fg-accent)">
                <UiIcon name="stack-2" variant="outlined" height={18} strokeWidth={2} />
              </div>
              <div className="flex items-center justify-center size-[30px]">
                <UiIcon name="calendar-week" variant="outlined" height={18} strokeWidth={2} />
              </div>
              <div className="flex items-center justify-center size-[30px]">
                <UiIcon name="books" variant="outlined" height={18} strokeWidth={2} />
              </div>
              <div className="flex items-center justify-center size-[30px]">
